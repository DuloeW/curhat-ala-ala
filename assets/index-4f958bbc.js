 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ai="analytics",_E="firebase_id",SE="origin",DE=60*1e3,xE="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Yf="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function op(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function ap(t){const e=t.mapValue.fields.__previous_value__;return op(e)?ap(e):e}function or(t){const e=hn(t.mapValue.fields.__local_write_time__.timestampValue);return new xe(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cp{}class _e extends cp{constructor(e,n,s){super(),this.field=e,this.op=n,this.value=s}static create(e,n,s){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,s):new CI(e,n,s):n==="array-contains"?new DI(e,s):n==="in"?new xI(e,s):n==="not-in"?new kI(e,s):n==="array-contains-any"?new RI(e,s):new _e(e,n,s)}static createKeyFieldInFilter(e,n,s){return n==="in"?new _I(e,s):new SI(e,s)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&this.matchesComparison(ls(n,this.value)):n!==null&&Ln(this.value)===Ln(n)&&this.matchesComparison(ls(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return j()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}}class bt extends cp{constructor(e,n){super(),this.filters=e,this.op=n,this.ht=null}static create(e,n){return new bt(e,n)}matches(e){return up(this)?this.filters.find(n=>!n.matches(e))===void 0:this.filters.find(n=>n.matches(e))!==void 0}getFlattenedFilters(){return this.ht!==null||(this.ht=this.filters.reduce((e,n)=>e.concat(n.getFlattenedFilters()),[])),this.ht}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const e=this.lt(n=>n.isInequality());return e!==null?e.field:null}lt(e){for(const n of this.getFlattenedFilters())if(e(n))return n;return null}}function up(t){return t.op==="and"}function lp(t){return TI(t)&&up(t)}function TI(t){for(const e of t.filters)if(e instanceof bt)return!1;return!0}function Ca(t){if(t instanceof _e)return t.field.canonicalString()+t.op.toString()+hs(t.value);if(lp(t))return t.filters.map(e=>Ca(e)).join(",");{const e=t.filters.map(n=>Ca(n)).join(",");return`${t.op}(${e})`}}function hp(t,e){return t instanceof _e?function(n,s){return s instanceof _e&&n.op===s.op&&n.field.isEqual(s.field)&&Ot(n.value,s.value)}(t,e):t instanceof bt?function(n,s){return s instanceof bt&&n.op===s.op&&n.filters.length===s.filters.length?n.filters.reduce((r,i,o)=>r&&hp(i,s.filters[o]),!0):!1}(t,e):void j()}function fp(t){return t instanceof _e?function(e){return`${e.field.canonicalString()} ${e.op} ${hs(e.value)}`}(t):t instanceof bt?function(e){return e.op.toString()+" {"+e.getFilters().map(fp).join(" ,")+"}"}(t):"Filter"}class CI extends _e{constructor(e,n,s){super(e,n,s),this.key=U.fromName(s.referenceValue)}matches(e){const n=U.comparator(e.key,this.key);return this.matchesComparison(n)}}class _I extends _e{constructor(e,n){super(e,"in",n),this.keys=dp("in",n)}matches(e){return this.keys.some(n=>n.isEqual(e.key))}}class SI extends _e{constructor(e,n){super(e,"not-in",n),this.keys=dp("not-in",n)}matches(e){return!this.keys.some(n=>n.isEqual(e.key))}}function dp(t,e){var n;return(((n=e.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(s=>U.fromName(s.referenceValue))}class DI extends _e{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return Nc(n)&&ar(n.arrayValue,this.value)}}class xI extends _e{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&ar(this.value.arrayValue,n)}}class kI extends _e{constructor(e,n){super(e,"not-in",n)}matches(e){if(ar(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&!ar(this.value.arrayValue,n)}}class RI extends _e{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!Nc(n)||!n.arrayValue.values)&&n.arrayValue.values.some(s=>ar(this.value.arrayValue,s))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt{constructor(e){this.fields=e,e.sort(He.comparator)}static empty(){return new vt([])}unionWith(e){let n=new ke(He.comparator);for(const s of this.fields)n=n.add(s);for(const s of e)n=n.add(s);return new vt(n.toArray())}covers(e){for(const n of this.fields)if(n.isPrefixOf(e))return!0;return!1}isEqual(e){return cs(this.fields,e.fields,(n,s)=>n.isEqual(s))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zI=new Ne(U.comparator);function Kt(){return zI}const kp=new Ne(U.comparator);function Bs(...t){let e=kp;for(const n of t)e=e.insert(n.key,n);return e}function Rp(t){let e=kp;return t.forEach((n,s)=>e=e.insert(n,s.overlayedDocument)),e}function Dn(){return qs()}function Np(){return qs()}function qs(){return new bs(t=>t.toString(),(t,e)=>t.isEqual(e))}const GI=new Ne(U.comparator),WI=new ke(U.comparator);function ee(...t){let e=WI;for(const n of t)e=e.add(n);return e}const YI=new ke(oe);function Bp(){return YI}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
